...
public class Manager {
	...
	public Manager(String userAccountName, String name, String work, String phone, String email) {
		super();
	...
	public String toString() {
		return "Manager [userAccountName=" + userAccountName + ", name=" + name + ", work=" + work + ", phone=" + phone
				+ ", email=" + email + "]";
	}
