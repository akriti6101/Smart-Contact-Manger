...
<div class="div0" >
 ...
 <div class="div21" >
       <p class="p11" >ADD CONTACT</p>
       <form action="${pageContext.request.contextPath}/submitContact/${username}"  enctype="multipart/form-data" method="post" >
        <div class="div211">
        ...
        <h6><i class="fa fa-plus" style="font-size:18px;margin-right:6px;color:grey" ></i>
            <input placeholder="Enter Contact Name"  type="text"name="name" class="inp" /><br/>
        ...
        <h6><i class="fa solid fa-envelope" style="font-size:18px;margin-right:6px;color:grey"></i>
           <input placeholder="Enter Email Address" name="email"  type="text"  class="inp"   /><br/>
         ...
         <h6><i class="fa fa-phone" style="font-size:18px;margin-right:6px;color:grey"></i>
           <input placeholder="Enter Contact Number" name="phone"  type="text"  class="inp"   /><br/>
         ...
         <h6><i class="fa fa-briefcase" style="font-size:18px;margin-right:6px;color:grey"></i>
           <input placeholder="Enter Work Experience" name="work"  type="text"  class="inp"  />
        </h6>
