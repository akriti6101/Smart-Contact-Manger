...
<div class="div0" >
 ...
 <div class="div21" >
         <p class="p11" >EDIT YOUR  PROFILE </p>
     
            
       <form action="${pageContext.request.contextPath}/profileUpdate/${username}"  enctype="multipart/form-data" method="post" >
        <div class="div211">
        ...
        <h6><i class="fa fa-plus" style="font-size:18px;margin-right:6px;color:grey" ></i>
            <input placeholder="Enter Your Name"  type="text"name="name" class="inp"  value="${ex.name}" /><br/>
        ...
        <h6><i class="fa solid fa-envelope" style="font-size:18px;margin-right:6px;color:grey"></i>
           <input placeholder="Enter  your Email Address" name="email"  type="text"  class="inp"  value="${ex.email}" /><br/>
         ...
         <h6><i class="fa fa-phone" style="font-size:18px;margin-right:6px;color:grey"></i>
           <input placeholder="Enter your Contact Number" name="phone"  type="text"  class="inp" value="${ex.phone}"  /><br/>
         ...
         <h6><i class="fa fa-briefcase" style="font-size:18px;margin-right:6px;color:grey"></i>
           <input placeholder="Enter your Work Experience" name="work"  type="text"  class="inp" value="${ex.work}"  />
        </h6>
         ...
         <h6><i class="fa fa-user-circle-o" style="font-size:18px;margin-right:6px;color:grey"></i>
           ...
           <button type="submit">EDIT PROFILE</button>
            ...
            <div class="div22">
                  <img  class="img1" style="width:180px;" src="<c:url value="/images/${ex.filename}"/>"/>
             </div>
